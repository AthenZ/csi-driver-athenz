...
// Interface provide the root PEM encoded X.509 Certificate Authority
// certificates of the trust domain. Consumers can subscribe to events to when
// the root certificates change.
