...
test-e2e-deps: INSTALL_OPTIONS += --set app.trustDomain=athenz.io
test-e2e-deps: INSTALL_OPTIONS += --set app.approver.signerName=clusterissuers.cert-manager.io/csi-driver-athenz-ca
test-e2e-deps: INSTALL_OPTIONS += --set app.issuer.name=csi-driver-athenz-ca
